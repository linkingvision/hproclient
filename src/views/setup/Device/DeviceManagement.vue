    ...
    <div class="left">
      ...
      <el-menu :default-active="active" @select="handleSelect" :collapse="isCollapse" :teleported="false">
        <el-sub-menu index="/DeviceManagement/VideoDevice">
          ...
          <el-menu-item index="/DeviceManagement/VideoDevice"><span>Video Device</span></el-menu-item>
          <!-- <el-menu-item index="/DeviceManagement/AccessControlDevice"><span>Access Control Device</span></el-menu-item> -->
        </el-sub-menu>
      </el-menu>
    </div>
    <div class="right">
